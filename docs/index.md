...
Re-verified 2026-09-10: Lean 4.32.0 commit `8c9756b28d64`, full `scripts/ci.sh` green (26 jobs, sorry-grep, axiom audit, self-test ok). Prior: 2026-08-16, 2026-08-31, 2026-09-02, 2026-09-03, 2026-09-09. A green `lake build` means the package compiled on 4.32.0. It does not mean an agent is safe.
