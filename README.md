...
| `BUILD-STATUS.md` | green build log (latest 2026-09-15 AEST) |
| `LICENSE` | MIT |
...
Verified on this host 2026-09-15 ~09:50 AEST (Melbourne): Lean 4.32.0 commit `8c9756b28d64`, full `scripts/ci.sh` green (`lake build` 26 jobs, sorry-grep, axiom audit, `self-test ok`). Prior greens: 2026-08-16, 2026-08-31, 2026-09-02, 2026-09-03, 2026-09-09, 2026-09-10, 2026-09-11, 2026-09-14.
